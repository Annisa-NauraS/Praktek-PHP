...
<a href="input-detailsiang.php"><button>Data Siang</button></a>
    <table border="1">
        <tr>
            <th>No</th>
        ...
        <?php
        $data = mysqli_query($connect, "SELECT bootcamp.*, users.nama FROM users INNER JOIN bootcamp ON users.id=bootcamp.id where bootcamp.jadwal='Pagi'");
